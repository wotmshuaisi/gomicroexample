...
/*
Package basis is a reverse proxy.
...
// RegisterSayHandler registers the http handlers for service Say to "mux".
// The handlers forward requests to the grpc endpoint over the given implementation of "SayClient".
...
var (
	pattern_Say_Hello_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"basis", "hello"}, ""))
)
